				...
				<nav
					...
					<div class="collapse navbar-collapse justify-content-between"
						...
						<div class="navbar-nav mr-auto py-0">
							...
							<div class="nav-item dropdown">
								<a href="#" class="nav-link dropdown-toggle"
									data-toggle="dropdown"><%=u.getName()%> <i
									class="fa fa-angle-down mt-1"></i></a>
								<div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
									<a href="seller-profile.jsp" class="dropdown-item">Seller
										Profile</a> <a href="seller-change-password.jsp"
										class="dropdown-item">Change Password</a> <a
										href="seller-logout.jsp" class="dropdown-item">Logout</a>
								</div>
							</div>
						</div>
