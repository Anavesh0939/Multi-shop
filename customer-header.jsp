...
<%@page import="model.bloodcustomer"%>
...
%>
<%
bloodcustomer s = null;
if(session.getAttribute("data")!=null){
	s = (bloodcustomer)session.getAttribute("data");
}
else{
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <a href="cart.jsp" class="btn px-0 ml-3">
                                ...
                                <%List<Cart> clist = CartDao.getCartByCusId(s.getId());  %>
                                <span class="badge text-secondary border border-secondary rounded-circle" style="padding-bottom: 2px;"><%out.print(clist.size()); %></span>
                            </a>
                        </div>
                    </div>
                </nav>
