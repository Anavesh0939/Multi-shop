...
<script type="text/javascript">
	...
	function CreateOrderID()
	{
		...
		xhttp.open("GET","http://localhost:8082/Project/OrderCreation?amount="+number+"&id="+cid,false);
		/* alert("2"); */
		xhttp.send();
...
<script type="text/javascript">
	function OpenCheckOut()
	{
		...
		var options={
				...
				"callback_url":"http://localhost:8082/Project/customer-home.jsp",
				"prefill":{
					"name":"Anavesh",
					"email":"Anavesh1234@gmail.com",
					"contact":"9106689849"
				},
				"notes":{
					"address":"Ahmedabad"
