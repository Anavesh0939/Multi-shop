...
<body>
	...
	<div class="container-fluid">
		<h2
			...
			<span class="bg-secondary pr-3">Manage Product</span>
		</h2>
					...
					<div class="control-group">
						...
						<div class="control-group">
							<input type="text" class="form-control" name="pname" id="name"
								value="<%=p.getPname() %>" required="required"
								data-validation-required-message="Product Name" />
							<p class="help-block text-danger"></p>
						</div>
						<div class="control-group">
							<input type="text" class="form-control" name="pprice" id="name"
								value="<%=p.getPprice() %>" required="required"
								data-validation-required-message="Product Price" />
							<p class="help-block text-danger"></p>
						</div>
						<div class="control-group">
							<input type="text" class="form-control" name="pcategory" id="name"
								value="<%=p.getPcategory() %>" required="required" />
							<p class="help-block text-danger"></p>
						</div>

						<div class="control-group">
							<input type="text" class="form-control" name="pdesc" id="email"
